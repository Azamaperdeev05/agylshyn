  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-40 w-full">
        {/* Global Top Nav (Apple Clean White, 12px quiet typography) */}
        <div className="h-12 sm:h-11 bg-white/95 dark:bg-[#161617]/95 text-[#86868b] border-b border-[rgba(0,0,0,0.06)] dark:border-[rgba(255,255,255,0.08)] backdrop-blur-md">
          <div className="max-w-[1024px] mx-auto px-4 sm:px-6 h-full flex items-center justify-between text-[12px] tracking-[-0.01em]">
            ...
            >
              ...
              <span className="font-semibold text-[#1d1d1f] dark:text-white tracking-tight text-[13px] sm:text-[12px]">
                English Dictation
              </span>
            </button>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                type="button"
                onClick={() => setActiveTab("settings")}
                className="flex items-center gap-1.5 text-[#86868b] hover:text-[#1d1d1f] dark:hover:text-white transition-colors cursor-pointer text-[11px] sm:text-[12px]"
              >
                {apiStatus.configured ? (
                  <>
                    <span className="w-2 h-2 rounded-full bg-[#34c759] shadow-xs" />
                    <span className="hidden sm:inline">ElevenLabs Connected</span>
                  </>
                ) : (
                  <>
                    <span className="w-2 h-2 rounded-full bg-[#ff9f0a]" />
                    <span className="hidden sm:inline">Setup Key</span>
                  </>
                )}
              </button>
            </div>
        ...
        {/* 2. Sub-Nav Frosted Glass (Desktop Only, 52px) */}
        <div className="hidden sm:block h-[52px] bg-white/85 dark:bg-[#1d1d1f]/85 backdrop-blur-xl border-b border-[rgba(0,0,0,0.08)] dark:border-[rgba(255,255,255,0.08)]">
          <div className="max-w-[1024px] mx-auto px-4 sm:px-6 h-full flex items-center justify-between">
            ...
            {/* Desktop Tabs + Action Pill */}
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1 sm:gap-2">
                <button
                  type="button"
                  onClick={() => setActiveTab("practice")}
                  className={`text-[13px] px-3 py-1 rounded-full transition-all cursor-pointer ${
                    activeTab === "practice"
                      ? "text-[#0066cc] dark:text-[#2997ff] font-semibold bg-[rgba(0,102,204,0.08)]"
      ...
      {/* 3. Native iOS Bottom Tab Bar (Mobile Only) */}
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-[#161617]/95 backdrop-blur-xl border-t border-[rgba(0,0,0,0.08)] dark:border-[rgba(255,255,255,0.08)] px-6 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] shadow-lg">
        <div className="flex items-center justify-around">
          ...
          >
            ...
            <span className="text-[11px] font-medium tracking-tight">Жаттығу</span>
          </button>
          ...
          >
            ...
            <span className="text-[11px] font-medium tracking-tight">Тарих</span>
          </button>
          ...
          >
            ...
            <span className="text-[11px] font-medium tracking-tight">Баптаулар</span>
          </button>
        </div>
      </nav>
    </>
